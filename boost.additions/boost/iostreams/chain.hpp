...
//      Mode - A mode tag.
//
//#define LIST_TYPE_EXPOSE
#ifdef LIST_TYPE_EXPOSE
  #define LIST_TYPE_PUBLIC public:
  #define LIST_TYPE_PRIVATE private:
#else
  #define LIST_TYPE_PUBLIC
  #define LIST_TYPE_PRIVATE
#endif  
