...
namespace boost { namespace spirit { namespace x3 { namespace detail
{
    ...
    struct rule_parser
    {
          ...
          , mpl::false_)
        {
          ...
          #if 0 && defined(USE_TRACE_SCOPE)
            boost::trace_scope _trace_scope(__func__);
            std::cout<<"Attribute="<<demangle_type<Attribute>()<<";\n";
            std::cout<<"ActualAttribute="<<demangle_type<ActualAttribute>()<<";\n";
            std::cout<<"demangle_type(rhs)="<<demangle_type(rhs)<<";\n";
          #endif  
            Iterator i = first;
            bool r = rhs.parse(
                i
          ...
          , ExplicitAttrPropagation)
        {
            ...
            constexpr auto propagate_attr=
              mpl::bool_
              < (  RHS::has_action
                && !ExplicitAttrPropagation::value
                )
              >();
            using rhs_attr_t = typename traits::attribute_of<RHS,Context>::type;
          #ifdef USE_TRACE_SCOPE
            boost::trace_scope _trace_scope(__func__);
            std::cout<<"Attribute      =\n";
            std::cout<<demangle_fmt_type<Attribute>();
            std::cout<<";\n";
            std::cout<<"ActualAttribute=\n";
            std::cout<<demangle_fmt_type<ActualAttribute>();
            std::cout<<";\n";
            std::cout<<"rhs_attr_t     =\n";
            std::cout<<demangle_fmt_type<rhs_attr_t>();
            std::cout<<";\n";
          #endif
            ...
            //std::cout<<__func__<<":attr_="<<demangle_type(attr_)<<";\n";
...
#endif
                ok_parse = parse_rhs(rhs, first, last, context, attr_, attr_, propagate_attr);
            }
            if (ok_parse)
            {
