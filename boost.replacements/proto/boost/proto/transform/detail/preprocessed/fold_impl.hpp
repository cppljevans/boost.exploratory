      ...
      : transform_impl<Expr, State, Data>
    {
        ...
        ) const
        {
            ...
            auto& c0 = proto::child_c< 0>(e);
            state1 s1 = 
              typename when<_, Fun>::template impl< typename result_of::child_c<Expr, 0>::type , state0 , Data >()(c0 , s0 , d );
            return s1;
        }
    };
    template<typename State0, typename Fun, typename Expr, typename State, typename Data>
      ...
      : transform_impl<Expr, State, Data>
    {
        ...
        ) const
        {
            ...
            std::cout<<"demangle s2=\n"<<demangle_fmt_type(s2)<<";\n"<<std::flush;
            auto child1=proto::child_c<1>(e);
            std::cout<<"demangle child1=\n"<<demangle_fmt_type(child1)<<";\n"<<std::flush;
            state1 s1 = typename when<_, Fun>::template impl< typename result_of::child_c< Expr , 1 >::type , state2 , Data >()( child1 , s2 , d ); 
            std::cout<<"demangle s1=\n"<<demangle_fmt_type(s1)<<";\n"<<std::flush;
            auto child0=proto::child_c<0>(e);
            std::cout<<"demangle child0=\n"<<demangle_fmt_type(child0)<<";\n"<<std::flush;
            state0 s0 = typename when<_, Fun>::template impl< typename result_of::child_c< Expr , 0 >::type , state1 , Data >()( child0 , s1 , d );
            std::cout<<"demangle s0=\n"<<demangle_fmt_type(s0)<<";\n"<<std::flush;
            return s0;
        }
    };
    template<typename State0, typename Fun, typename Expr, typename State, typename Data>
