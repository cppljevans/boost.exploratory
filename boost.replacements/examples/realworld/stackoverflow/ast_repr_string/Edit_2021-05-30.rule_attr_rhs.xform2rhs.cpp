...
namespace boost { namespace spirit { namespace x3 { namespace traits
{
      ...
      >
    {
        ...
        static void post(Exposed& val, Transformed&& attribute)
        {
            ...
            std::cout<<":demangle_fmt_type(val)="<<demangle_fmt_type(val)<<":demangle_fmt_type(attribute)="<<demangle_fmt_type(attribute)<<";\n";
          #endif
...
main()
{
  ...
  {
    std::cout<<"***ON LINE:"<<__LINE__<<";\n";
    std::cout<<"gap_attr="<<demangle_fmt_type<gap_attr>()<<";\n";
  }
#endif
#if 0
  //This compiles
  ...
  #else
    std::cout<<":demangle_fmt_type(start_attr)="<<demangle_fmt_type(ast)<<";\n";
