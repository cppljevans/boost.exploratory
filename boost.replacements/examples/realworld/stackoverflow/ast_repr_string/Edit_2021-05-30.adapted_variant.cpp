...
namespace minimal { namespace ast
{
  ...
  #ifdef WITHOUT_WHITE
  struct gap_item   : boost::variant<char,braced>  {};
  #else // WITHOUT_WHITE
  struct gap_item   : boost::variant<white,braced> {};
  #endif // WITHOUT_WHITE
  struct gap        : std::vector<gap_item>     {};

  #ifndef WITH_GAP_ITEM_IN_VARIANT
  struct start_item : boost::variant<gap,std::string>  {};
  #else // WITH_GAP_ITEM_IN_VARIANT
  struct start_item : boost::variant<gap,std::string,gap_item,char>  {};
...
namespace boost { namespace fusion
{
    ...
    {
        template<>
        struct tag_of<minimal::ast::gap_item>
        {
